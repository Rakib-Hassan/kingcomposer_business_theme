...
class Accordion extends ExtensionsController {
							...
							array(
								...
								*/
								...
								'params' => array(
									...
									array(
										'type'        => 'editor',
										'label'       => __( 'Accordion Content', 'kingcomposer' ),
										'name'        => 'acc_descr',
										'description' => __( 'Content of the Accordion.', 'kingcomposer' ),
	...
	function rdextkc_accordion_func( $atts, $content = null ) {
		...
		if ( isset( $acoptions ) ) {
			foreach ( $acoptions as $option ) {
                ...
                <div style="background:' . $descr_bg_color . '; border: 2px solid '.$border_color.'; border-top: none;" class="ac-content">
                   <p style="font-size:' . $d_f_size . '; "> ' . $option->acc_descr . ' </p>
                </div>
            </div>';
			}
		}
		...
		// Master Custom CSS
		require "customcss/customcss.php";
