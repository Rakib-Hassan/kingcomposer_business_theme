...
use Eak\Api\Callbacks\ManagerCallbacks;
use Eak\Api\SettingsApi;
use Eak\Base\BaseController;
use Eak\Api\Callbacks\AdminCallbacks;
...
class AdminPages extends BaseController {
	...
	public function setPages() {
		$this->pages = array(
			array(
				'page_title' => 'Essensial Addons For King Composer',
				'menu_title' => 'EAK Addons',
...
/*	public function setSubpages() {
	...
	public function setFields() {
		...
		foreach ( $this->shortcodes as $key => $value ) {
			...
			$args[] = array(
				'id'       => $key,
				'title'    => $value . '<br> <p style="font-size: 9px; color: #999; margin: 0, padding: 0;">' . $value . ' addons for kc</p>',
