...
$plugin_data    = get_plugin_data( $filpath . 'essential-addons-for-kingcomposer.php' );
$plugin_version = $plugin_data['Version'];
?>

<div id="pev-wrap">
    <div id="pev-desc-main">
        <h3 id="pev-title">Welcome to Essential Addons For KingComposer</h3>
        <p>Essential Addons has module basis structure. You can easily Enable/Disable any Addons as your needs anytime. When you updated plugin, you can check this page and activate new
            Addon.</p>
        <p>All Addons Activate By Default, You Should Deactivate Addons Which One you like, You may deactivate/activate All Addons By Clicking Enable/Disable Button.</p>
    </div>
        ...
        <div id="tab-2" class="tab-pane">
            ...
            <div class="prime-page-welcome about-wrap container">
                <div class="prime_welcome-feature">
                    <!--<div class="about-text">The Essential Addons  Bundle VC Addons currently has a lot of modules. It will be updated periodically and you'll get much more modules & existing modules will be
                        improved.
                    </div>-->
                    ...
                    <div class="prime-grid-wrapper row">
                        <div class="col-md-6 prime-grid-item ">
                            <h4><span class="dashicons dashicons-images-alt2 prime_lefticon"></span>What is the Essential Addons Bundle for KingComposer?</h4>
                            <p>The Essential Addons Bundle for KingComposer is developed to extend KingComposer to save your time in building websites. This plugin adds a number of elements to the basic set of elements that come with the page builder. All these elements are added to your KingComposer editor and can be used just like any other built-in features.</p>
                        </div>

                        <div class="col-md-6 prime-grid-item">
                            <h4><span class="dashicons dashicons-admin-settings prime_lefticon"></span> Icons, Fonts, Typography, Design</h4>
                            <p>Infinity effects & variations usage comes with Essential Addons  Bundle VC Addons in your way. You can apply your own customized shortcodes in anywhere with flexible
                                effects.</p>
                        </div>
                    </div>
                    <div class="prime-grid-wrapper">
                        <div class="col-md-6 prime-grid-item">
                            ...
                            <p>With the Essential Addons Bundle Addons, you are free to use the basic elements of KingComposer with several advanced elements that it adds in the editor.</p>
                        </div>

                        <div class="col-md-6 ">
                            <h4><span class="dashicons dashicons-universal-access prime_lefticon"></span> We stand by you!</h4>
                            <p>With several video tutorials and a dedicated support team, we assure complete help and support whenever you need us. Go ahead and explore the Prime elements of the Essential Addons Bundle for KingComposer!</p>
                        </div>
                    </div>
